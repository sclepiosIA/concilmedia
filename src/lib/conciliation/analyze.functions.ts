...
export type AIAnalysisPayload = {
  synthese: string;
  score_risque: number;
  interactions: Array<{ dci_1: string; dci_2: string; severite: string; mecanisme: string; recommandation: string; risque?: string; reference?: string }>;
  doublons_therapeutiques: Array<{ medicaments: string[]; classe: string; recommandation: string; severite?: string; mecanisme?: string; risque?: string; reference?: string }>;
  contre_indications: Array<{ medicament: string; raison: string; recommandation: string; severite?: string; mecanisme?: string; risque?: string; reference?: string }>;
  redondances_classe: Array<{ classe: string; medicaments: string[] }>;
  adaptations_posologiques: Array<{ medicament: string; raison: string; recommandation: string; severite?: string; mecanisme?: string; risque?: string; reference?: string }>;
  medicaments_haut_risque?: Array<{ medicament: string; classe: string; raison: string; severite?: string; risque?: string; recommandation?: string; reference?: string }>;
  allergies_croisees?: Array<{ allergene: string; medicament: string; risque: string; severite?: string; recommandation?: string; reference?: string }>;
