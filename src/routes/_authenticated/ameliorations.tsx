...
const PISTES: Piste[] = [
  ...
  },
  {
    ...
    miseEnOeuvre: [
      "Comparaison habituel / entrée / sortie + détection introduits, arrêtés, modifiés, repris",
      "Génération IA HAS-compliant enrichie des allergies et comorbidités",
      "Versioning des lettres (régénération sans écrasement), édition manuelle avant validation",
      "Export PDF natif, envoi MSSanté simulé avec journal d'envoi traçable",
      "Pré-remplissage des destinataires depuis la fiche patient",
    ],
    prerequis: ["Intégration MSSanté réelle (carte CPS + certificat ANS) hors v2 — actuellement simulée"],
    statut: "Livré v2",
  },
  {
    id: 10,
